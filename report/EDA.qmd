...
# the pie chart
p1 <- ggplot(trip_percentages_Af, aes(x = "", y = Percentages, fill = F16_ENG)) +
  ...
  ggtitle("Percentage of Type of Trips - Africa") 
...
library(cowplot)
library(gridExtra)
plot_grid(p1, p2, p3, p4, p5, p6, align = c("v", "h"), labels = NULL) # Horizontal alignment

# Combine the plots
grid.arrange(p1, p2, p3, p4, p5, p6, nrow = 1) # Arrange in 1 row
