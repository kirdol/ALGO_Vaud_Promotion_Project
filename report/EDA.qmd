...
#plot swiss german vs other 
# Percentage_Swissgerman_vs_other <- Inside_Switzerland %>%
#     ifelse(Canton %in% swiss_german_cantons, sum(Count) if Canton %in% swiss_german_cantons, sum(Count) %notin%  swiss_german_cantons)
