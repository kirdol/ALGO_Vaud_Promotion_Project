...
ggplot(F05_01_PCT,
       aes(x=reorder(Continent_of_origin, Percentage),
           y=Percentage,
  ...
  labs(x="Continents of origin",
       y="Percentages",
       title="Percentage of Each Unique Continent of origin") +
...
ggplot(F05_02_PCT, aes(x = reorder(`F05_02_ENG`, Percentage), y = Percentage, fill = `F05_01_ENG`)) + 
  ...
  theme_minimal() +
  labs(title = "Percentage of Responses by Country and Continent of origin",
       x = "Country of Origin",
       y = "Percentages") +
...
Inside_Switzerland_ratio <- data_merged %>%
  ...
  select(Canton, Count, Population, Ratio, Scaled_Ratio)
