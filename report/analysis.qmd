...
We can clearly see two major moments in the year when there is an increase in the number of days spent in Vaud: March and July. This can be influenced by national holidays.
...
Let's now look at the percentage of nighstay trip per categories and continent. In the survey, visitors were asked to select the type of trip they took from 4 options, explained in the legend of the graph. So here is the graph of the distribution of the type of trip for each continent.
...
## Distribution Percentage Nightstays in Switzerland over Whole Trip
...
As this graph shows, we notice that over the whole trip in Europe, most of the people will come over for 20% of their trip, and few will spend more than 75% of their time in Switzerland.

## Distribution of Arrivals per Nationality

Now let's explore the distribution of the arrivals per nationality over the year. The full table of the arrivals can be found in the [Annex -@sec-data-arrivals].
