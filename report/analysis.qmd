...
NEED TO CHANGE INTO VICTOR'S DISTRICT

Looking at the categories of spendings, we decided to analyse and compare the districts' spendings and see for which category each district spends the most.
...
# Generate a list of unique cities (F105_OrgCode assumed correct column name)
