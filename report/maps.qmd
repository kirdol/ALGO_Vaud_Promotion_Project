...
The following maps depict how people travel to the canton of Vaud. It shows the proportion of visitors that cam to one of the region with their children, alone or as a couple. Note that someone can be in multiple categories. For example, someone can be a couple and have children. He would then be counted in the couples and children categories.
...
Let's explore on a map the most frequently visited districts by French tourists. We seperated the tourists from Île-de-France, Auvergne-Rhône-Alpes and the rest of France to check for different preferences patterns.
...
We can see on the maps that the tourists from Île-de-France are mainly interested in visiting Lausanne while the tourists from Auvergne-Rhône-Alpes and the rest of France are also interested in the region of Lausanne but also notably in the others regions.

## British tourists

You can find on the map below the most frequently visited districts by British tourists. We seperated the tourists from London, the rest of England and Scotland to check for different preferences patterns. There were too few visitors from Northern Ireland and Wales to be included in the map.
...
Let's look at a map with the most frequently visited districts by German tourists. We seperated the tourists from Baden-Württemberg, Bayern and Nordrhein-Westfalen to check for different preferences patterns.
...
Let's explore on a map the most frequently visited districts by US tourists. We seperated the tourists from California and the rest of the US to check for different preferences patterns.
