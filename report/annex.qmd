...
Find below the full techincal description of the dataset:

```{r echo = FALSE}
print(dfSummary(data), method = "render")
```

## Percentage per continent of visitors coming in the canton of Vaud
...
```{r Per city, the percentage of each visitor's country of origin, relative to the number of visitor of the city, echo=FALSE}
