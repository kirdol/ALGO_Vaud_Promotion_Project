...
Below you can find the map of the 10 districts in the canton of Vaud that we will have a better look at in this document.
...
value_palette <- leaflet::colorNumeric(palette = "lightblue", domain = vaud$value)
...
m <- leaflet(country) %>%
  ...
  addPolygons(weight = 1, color = "white", fillColor = "lightblue",
