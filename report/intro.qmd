...
Our report aims to simplify the comprehension of this raw data through data visualization techniques and plots. Additionally, we aim to categorize the types of tourists visiting Vaud and their regions of origin. This will help Vaud Promotion understand the demographics of visitors to the canton and possibly help with targeted marketing efforts.

The first part of our report presents the data in a more readable format. Following that, we conduct an exploratory data analysis (EDA), which involves creating basic charts to provide perspective and convey the scale of the variables to the reader. Next, we proceed to the analysis phase, where we cross-analyze multiple variables to highlight correlations. The final section of the report is dedicated to plotting various variables on a map of the districts of Canton Vaud. Lastly, we will articulate our conclusions about the survey data and share our experience with this report.

## An overview of the Districts and Countries of origin

### Districts of Canton Vaud

Below you can find the map of the 10 districts in the canton of Vaud for which we will have a better look at in this document.
...
You can find below the map of the countries of origin of the tourists visiting Vaud. This gives an idea of the scope of the survey and the diversity of the tourists visiting the canton.
